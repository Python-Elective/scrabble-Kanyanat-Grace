...
# print(calculate_hand_len({'g':1, 's':4, 'a':3}))
...
def play_hand(hand, word_list, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    # Display the hand
        ...
        display_hand(hand)
    # Ask user for input
        user_word = input('Enter word, or a "." to indicate that you are fisnihed: ')
    # If the input is a single period:
        if user_word == '.':
            print('Goodbye! ' + 'Total score: ' + str(total_score) + ' points. To replay:')
        ...
        # If the word is not valid:
            ...
            # Reject invalid word (print a message followed by a blank line)
                print('Invalid word pleace try again.')
                print()
...
def play_game(word_list):
    ...
    while True:
        ...
        user_input = input("Enter 'n' to deal a new hand, 'r' to replay the last hand, or enter 'e' to end the game :")
        if user_input == 'n':
            first_hand = deal_hand(n)
            play_hand(first_hand, word_list, n)
            second_hand = first_hand
        elif user_input == 'r':
            if second_hand == {}:
                print('You have not played a hand yet. Please play a new hand first!')
            else:
                play_hand(second_hand, word_list, n)
        elif user_input == 'e':
            print('Leaving already? Goodbye! Come play again!')
            break
        else:
